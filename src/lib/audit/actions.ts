...
export const AUDIT_ACTIONS = {
  ...
  // เข้าสู่ระบบด้วย Google สำเร็จ (D19) — แยกจาก LOGIN_SUCCESS เพื่อให้ผู้ตรวจสอบ
  // ตอบได้ว่าใครเข้าด้วยวิธีใด โดยไม่ต้องไปไล่อ่าน metadata ทีละแถว
...
export const AUDIT_ACTION_LABELS: Record<AuditAction, string> = {
  ...
  "auth.login.google": "เข้าสู่ระบบด้วย Google",
  "auth.identity.linked": "ผูกบัญชี Google",
  "auth.identity.unlinked": "ถอนการผูกบัญชี Google",
...
export const AUDIT_ENTITY_LABELS: Record<AuditEntityType, string> = {
  ...
  UserIdentity: "บัญชีที่ผูกจากภายนอก",
  Attachment: "ไฟล์แนบ",
  AuditLog: "Audit Log",
  Document: "หนังสือ",
}
