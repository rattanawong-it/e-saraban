...
/**
 * ข้อความของเส้นทาง Google (spec §17.3 · D19)
 *
 * callback ส่งกลับมาเป็นรหัสใน `?error=` ไม่ใช่ข้อความ เพราะ URL ที่มีข้อความไทย
 * ยาว ๆ อ่านไม่ออกและถูกคัดลอกไปแปะต่อได้ · การแปลอยู่ที่เดียวคือตรงนี้
 *
 * ⚠️ ข้อความต้องไม่บอกว่าอีเมลนั้นมีบัญชีอยู่ในระบบหรือไม่มากกว่าที่จำเป็น —
 * แต่ NO_ACCOUNT ต้องบอกทางออกให้ชัด ไม่งั้นผู้ใช้ใหม่จะติดตรงนี้แล้วโทรหาผู้ดูแลทุกคน
 */
export const LOGIN_ERRORS: Record<string, string> = {
  google_no_account:
    "ยังไม่มีบัญชีผู้ใช้ในระบบสำหรับอีเมลนี้ — กรุณาลงทะเบียนใช้งานแล้วรอผู้ดูแลอนุมัติก่อน",
  google_domain_not_allowed: "อนุญาตเฉพาะบัญชีอีเมลของมหาวิทยาลัยเท่านั้น",
  google_email_unverified: "บัญชี Google นี้ยังไม่ได้ยืนยันอีเมล จึงใช้เข้าสู่ระบบไม่ได้",
  google_inactive: "บัญชีนี้ถูกระงับการใช้งาน กรุณาติดต่อผู้ดูแลระบบ",
  google_expired: "ใช้เวลานานเกินไป กรุณากดเข้าสู่ระบบด้วย Google ใหม่อีกครั้ง",
  google_rate_limit: "พยายามเข้าสู่ระบบถี่เกินไป กรุณารอสักครู่แล้วลองใหม่",
  google_bad_request: "เข้าสู่ระบบด้วย Google ไม่สำเร็จ กรุณาลองใหม่ หรือใช้ชื่อผู้ใช้และรหัสผ่าน",
  google_failed: "เข้าสู่ระบบด้วย Google ไม่สำเร็จ กรุณาลองใหม่ หรือใช้ชื่อผู้ใช้และรหัสผ่าน",
}
...
/** หน้าทะเบียนหนังสือ (spec §10.1 · D12) — รูปแบบตามระเบียบสำนักนายกรัฐมนตรีว่าด้วยงานสารบรรณ */
export const REGISTER_REPORT = {
  title: "ทะเบียนหนังสือ",
  description:
    "ทะเบียนหนังสือรับและหนังสือส่งตามแบบของระเบียบสารบรรณ · ดึงออกเป็น Excel หรือ PDF ได้",
  book: "เล่มทะเบียน",
  bookOptions: {
    outgoing: "ทะเบียนหนังสือส่ง",
    incoming: "ทะเบียนหนังสือรับ",
  },
  bookHint: "หนังสือส่งรวมบันทึกข้อความภายใน เพราะเดินเลขจากทะเบียนของหน่วยงานเดียวกัน",
  orgUnit: "หน่วยงานเจ้าของทะเบียน",
  orgUnitHint: "รวมหน่วยงานลูกในสายงานเดียวกันให้อัตโนมัติ",
  year: "ปี พ.ศ.",
  ...
  exportNote: "ไฟล์ที่ดึงออกไปมีบันทึกใน audit ว่าใครดึงเมื่อไร และมีเอกสารชั้นความลับกี่ฉบับ",
  rowCount: (total: number) => `${total.toLocaleString("th-TH")} รายการ`,
  empty: "ไม่มีรายการในช่วงที่เลือก",
  scopeNote:
