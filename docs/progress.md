...
ข้อ B1c ให้ผู้ทดสอบยืนยันว่าหน่วยงานนับ**ปีปฏิทินหรือปีงบประมาณ** — เป็นคำถามที่ค้างมา
ตั้งแต่ §15 ข้อ 5 และ **ต่างกันจริงเมื่อถึง 1 ต.ค. 2569** · ถ้าคำตอบคือปีงบประมาณ
ต้องแก้ก่อนวันนั้น
