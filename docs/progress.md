...
**ที่ยังค้างจากขั้นนี้**

- `/admin/org-units` **ยังไม่มีสวิตช์ `canIssueNumber`** บนแผงรายละเอียด — แก้ค่าได้จาก SQL เท่านั้น
  ต้องเพิ่มก่อนถึงงานออกเลข ไม่งั้นข้อยกเว้นใน spec §16 แก้ไม่ได้
- ผังยาว 372 หน่วยทำให้หน้า `/admin/org-units` สูง ~10,000px — P1 ออกแบบไว้กับ 11 หน่วย
  ควรพับกิ่งระดับ 1 เป็นค่าเริ่มต้น หรือมีช่องค้นหาในผัง
