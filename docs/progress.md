...
**ยังไม่ทำ: UAT** — สเปก §13 กำหนดว่าต้องผ่านกับผู้ใช้จริง ≥ 5 คนจาก 3 หน่วยงาน
และ §14 ระบุสามอย่างที่ต้องมีของจริงมาเทียบ (ออกเลข 20 ฉบับเทียบสมุดทะเบียนกระดาษ ·
ทดสอบบนมือถือจริง · เทียบ Export Excel กับรูปแบบที่หน่วยงานใช้อยู่) — ทำแทนไม่ได้
สิ่งที่ทำให้ได้คือสคริปต์ UAT ให้ผู้ทดสอบเดินตาม ซึ่งยังไม่ได้เขียน

### 23.14 ⏳ ของที่ยังค้างใน P5

1. ~~**Notification in-app**~~ — เสร็จแล้ว (§23.8–23.12)
2. ~~**คู่มือผู้ใช้**~~ — เสร็จแล้ว หน้า `/help` (§23.13) · **UAT ยังไม่ได้ทำ**
   ต้องมีผู้ใช้จริง ≥ 5 คนจาก 3 หน่วยงาน · สคริปต์ UAT ให้ผู้ทดสอบเดินตามยังไม่ได้เขียน
...
6. ของค้างจาก §22.7 ข้อ 1–5 ยังค้างเหมือนเดิมทั้งหมด
