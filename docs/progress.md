...
**ที่ยังไม่ได้ทำในขั้นนี้**

- ยังไม่มีข้อมูลใน `document_types` — ต้องรู้ก่อนว่าองค์กรใช้ประเภทหนังสืออะไรบ้าง
  (บันทึกข้อความ · หนังสือส่งภายนอก · คำสั่ง · ประกาศ · หนังสือรับ) และแต่ละประเภทใช้ pattern เดียวกันไหม
- `issueNumber()` · renderer ของ pattern · service ฝั่งเอกสาร — ขั้นถัดไป
