...
| **D14** | ผังหน่วยงานจริง *(25 ส.ค. 2569)* | ใช้ **รหัสงานสารบรรณ 6 หลัก** ของมหาวิทยาลัยเกริก (สรุป ณ 21 ส.ค. 2569) — 371 หน่วย 3 ระดับ · แทนผังตัวอย่าง `ศธ 0512.x` ที่ใช้ชั่วคราวใน P1 · รายการเต็มอยู่ที่ §16 และ `docs/org-units.csv` |
...
**ฉบับที่เครื่องอ่านได้: `docs/org-units.csv`** — ใช้ไฟล์นี้เป็นแหล่งเดียวตอนเขียน `prisma/seed.ts`
...
*เอกสารฉบับนี้เป็น baseline สำหรับการพัฒนา — การเปลี่ยนแปลง requirement ให้บันทึกเพิ่มใน §2 Decisions Log เป็น D17, D18, … พร้อมวันที่และเหตุผล*
